...
class stock(object):
    def __init__(self, __stockExchange, __stockCode, __associateData = {}, headers = [],
                 ...
                 __stockFile = urllib.request.URLopener(), __mostRecentParsed = None, __RSSDataDict = None,
        ...
        self.openLink = False
        self.__stockFile = urllib.request.URLopener()
    ...
    # Converts an input date of the format DD-MMM-YY to DD-mm-YYYY
    ...
    # Loads an available price sheet.
    # dateList input should be... # TODO:
    # todaysDate will actually be today's date if given a value of true or false
    #   . If given an alternate date in the correct format, it will treat that
    #   as today, which is useful for spoofing a day in order for testing.
    def load_price_sheet(self, dateList, todaysDate):
        ...
        # opens and loads file data in, checking if empty
        ...
        # Clean data and put in self.__modStockData for easier analysis
        for x in range(len(self.__modStockData)):
            for y in range(5):
                if y != 0:
...
##            print item
    ...
    # Returns boolean list relative to 2 columns indicating peaks and troughs
    ...
    # calculates standard deviation of a list, echos is specified
    ...
    # Returns false if no volume present in modified stock data
...
##            print self.__modStockData[volCheck][5]
    ...
    ## RSS Functions
    ##################################################
    # Links to google RSS feed, creates folders. Adds
...
##        print self.__currentRSSDD.keys()
    ...
    # Displays an RSS entry, beeps if requested
    def __RSS_display_update(self, entry, stockTitle, isBeep):
        ...
        if isBeep: sounda.play()

    # Checks if RSS dict needs to be updated
    ...
    # Searches for a keyword in RSS feed
...
##                        print "found in summary for story dated", entry["published"]
    ...
    # Custom data addition to stock object
    ...
    # Custon data retrieval from stock object
    ...
    # Shorthand to retrieve associate data
    def rad(self, key):
...
##            return False
        print("--------------------------------------------------")
        print("Date:", printLine[0], end=' ')
        print("Open:", printLine[1], end=' ')
        print("High:", printLine[2], end=' ')
        print("Low:", printLine[3], end=' ')
        print("Close:", printLine[4], end=' ')
        print("Volume:", printLine[5])
        try: print("Open Change:", printLine[6], end=' ')
        except: pass
        try: print("High Change:", printLine[7], end=' ')
        except: pass
        try: print("Low Change:", printLine[8], end=' ')
        except: pass
        try: print("Close Change:", printLine[9], end=' ')
        except: pass
        try: print("Volume Change:", printLine[10])
        except: pass
        try: print("15 day moving average:", printLine[11], end=' ')
        except: pass
